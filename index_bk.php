      ...
      <div class="container">
         ...
         <div class="row stats-wrapper">
            <div class="box" style="color:red">
               <h4 class="stats-number" id="bgkCount">-</h4>
               <p>Positive</p>
            </div>
            ...
            <div class="box" style="">
               <h4 class="stats-number" id="awaitedCount">-</h4>
               <p>Results Awaited</p>
            </div>
            <div class="box" style="">
               <h4 class="stats-number" id="totalSamplesCount">-</h4>
               <p>Total Samples</p>
            </div>
            <div class="box" style="">
               <h4 class="stats-number" id="stateCount">-<span></span></h4>
               <p>Karnataka</p>
            </div>
         </div>
		 <hr/>
